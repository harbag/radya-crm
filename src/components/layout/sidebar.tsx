  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto py-3">
        <p
          className={cn(
            "mb-1 px-4 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground transition-opacity",
            collapsed && "opacity-0"
          )}
        >
          Modules
...
export function DesktopSidebar() {
  ...
  return (
    <aside
      className={cn(
        "hidden md:flex shrink-0 flex-col bg-card border-r border-border transition-all duration-200",
        collapsed ? "w-14" : "w-60"
      )}
    >
      ...
      <div className="flex h-14 items-center border-b border-border px-3">
        {!collapsed && (
          <div className="flex flex-1 items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted-foreground truncate">Radya Group</p>
            </div>
          </div>
        )}
        {collapsed && (
        ...
        <button
          onClick={toggle}
          className={cn(
            "flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors shrink-0",
...
export function MobileSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-60 flex-col bg-card border-r border-border transition-transform duration-200 md:hidden",
...
export function MobileTopBar() {
  ...
  return (
    <div className="flex h-12 items-center gap-3 border-b border-border bg-background px-3 md:hidden">
      <button
        onClick={openMobile}
        className="flex h-8 w-8 items-center justify-center rounded-md text-foreground hover:bg-accent"
      >
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-semibold text-foreground">Radya CRM</span>
      </div>
    </div>
  );
}
